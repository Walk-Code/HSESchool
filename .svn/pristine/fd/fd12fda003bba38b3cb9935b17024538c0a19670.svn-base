	   ...
	   mWebView.setWebViewClient(new WebViewClient(){
		...
		public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				if (url.toLowerCase().contains("localaccesshsej://paymentresult")) {
					if(getIntent().getBooleanExtra("isNeedSuccessPage", false)){
						HashMap<String, String> urlParamsMap = DataLoader.getInstance().getUrlParamsMap(url);
						if(urlParamsMap.containsKey("dealNumber")){								
							Intent intent = new Intent(WebViewActivity.this, StorePayFinishActivity.class);
