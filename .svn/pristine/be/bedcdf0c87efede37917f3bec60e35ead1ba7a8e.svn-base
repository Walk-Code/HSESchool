...
public class DefineHandler {
	...
	public static boolean isMsgMyfriendVisible(Context context){
		...
		if(!obj.has("friend") && !obj.has("chat") && !obj.has("obligation")
				&& !obj.has("receiving") && !obj.has("evaluate") && !obj.has("refund")){
			return false;
		}
		if(obj.optInt("friend", 0) == 0 && obj.optInt("chat", 0) == 0 && obj.optInt("obligation", 0) == 0
				&& obj.optInt("receiving", 0) == 0 && obj.optInt("evaluate", 0) == 0 && obj.optInt("refund", 0) == 0){
			return false;
		}
		return true;
	}
	...
	public static int getAllUnreadCount(Context context){
		...
		if(!obj.has("msg") && !obj.has("friend") && !obj.has("chat") && !obj.has("obligation")
				&& !obj.has("receiving") && !obj.has("evaluate") && !obj.has("refund")){
			return 0;
		}
		
		if(obj.optInt("msg", 0) == 0 && obj.optInt("friend", 0) == 0 && obj.optInt("chat", 0) == 0 && obj.optInt("obligation", 0) == 0
				&& obj.optInt("receiving", 0) == 0 && obj.optInt("evaluate", 0) == 0 && obj.optInt("refund", 0) == 0){
			return 0;
		}
