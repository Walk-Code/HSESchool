...
public class Configs {
	 ...
	 * 是否使用测试服务器
	 */
	public static final boolean isUseTestServer = true;
	
	//测试=====正式
	public static final String ServerUrl = isUseTestServer ? "http://hseschool.app360.cn/app/" : "http://www.hsej.net/app/";
	public static final String PayUrl = "http://pay.hsej.net:99/PayPortal/";
//	public static final String ServerUrl = isUseTestServer ? "http://10.38.178.148:8080/hseschool/app/" : "http://www.hsej.net/app/";
	
	//本地测试
	//public static final String ServerUrl = "http://10.38.178.107:8080/hseschool/app/";
//	public static final String ServerUrl = "http://10.38.178.211:8080/hseschool/app/";
//	public static final String ServerUrl = "http://10.38.178.148:8080/hseschool/app/";
	...
	public final static String AdvertiseImg = "advertise.jpg";
