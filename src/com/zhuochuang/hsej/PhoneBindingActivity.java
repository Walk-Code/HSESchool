...
public class PhoneBindingActivity extends BaseActivity{
	...
	public void onTipBtnClick(View view){
		...
		case R.id.textview_seconds:
			...
			params.put("key", "");
			try {
				params.put("userId", SharedPreferenceHandler.getXPSUserId(PhoneBindingActivity.this));
			} catch (Exception e) {
		...
		case R.id.textview_done:
			...
			DataLoader.getInstance().startTaskForResult(TaskType.TaskOrMethod_UserBangdingPhone, param, PhoneBindingActivity.this);
