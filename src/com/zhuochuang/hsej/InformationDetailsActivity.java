...
public class InformationDetailsActivity extends BaseActivity{
	...
	private void initHeaderView() {
		mHeaderView = View.inflate(InformationDetailsActivity.this, R.layout.listcell_informationdetails_header, null);
			...
			if(mHeaderObj.has("images")){
				...
				mAutoGallery.setAdapter(new ContentAdapter(){
					...
					public View getView(int position, View convertView, ViewGroup parent) {
						// TODO Auto-generated method stub
						if(convertView == null){
							convertView = View.inflate(InformationDetailsActivity.this, R.layout.listcell_myschoolyard_headercell, null);
	...
	private void initListView(){
		...
		mListView.setAdapter(mListAdapter = new ContentAdapter(){
			...
			public View getView(final int position, View convertView, ViewGroup parent) {
				// TODO Auto-generated method stub
				if(convertView == null){
					convertView = View.inflate(InformationDetailsActivity.this, R.layout.listcell_postdetails, null);
