...
public class PhotoAlbumActivity extends Activity {
	...
	GridView gridView;
	PhotoAlbumAdapter adapter;// 自定义的适配器
	AlbumHelper helper;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.bucket_cancel).setOnClickListener(new OnClickListener() {
	...
	private void initView() {
		...
		adapter = new PhotoAlbumAdapter(PhotoAlbumActivity.this, dataList);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(PhotoAlbumActivity.this, PhotoAlbumChildActivity.class);
