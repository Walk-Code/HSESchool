...
//		lp.topMargin = getWindowManager().getDefaultDisplay().getWidth() - Utils.dipToPixels(this, 65);
//		findViewById(R.id.scan_text).setLayoutParams(lp);
	}
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			Intent intent = new Intent(QRcodeCaptureActivity.this, QRcodeResultActivity.class);
